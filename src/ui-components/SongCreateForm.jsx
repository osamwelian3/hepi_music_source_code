...
export default function SongCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setListens(initialValues.listens);
    setCurrentListensValue("");
    setTrendingListens(initialValues.trendingListens);
    setCurrentTrendingListensValue("");
    setListOfUidDownVotes(initialValues.listOfUidDownVotes);
    setCurrentListOfUidDownVotesValue("");
    setListOfUidUpVotes(initialValues.listOfUidUpVotes);
    setCurrentListOfUidUpVotesValue("");
    setName(initialValues.name);
    setPartOf(initialValues.partOf);
    setSelectedCategory(initialValues.selectedCategory);
    setSelectedCreator(initialValues.selectedCreator);
